...
<div class='footer__box1'>
<li>
<a href="<?php echo esc_url( home_url( '/tag/tops/' ) ); ?>">> トップス</a>
</li>
<li>
<a href="<?php echo esc_url( home_url( '/tag/bottoms/' ) ); ?>">> ボトムス</a>
</li>
</div>
<div class='footer__box2'>
<li>
<a href="<?php echo esc_url( home_url( '/tag/dresses/' ) ); ?>">> ドレス</a>
</li>
<li>
<a href="<?php echo esc_url( home_url( '/tag/accessories/' ) ); ?>">> アクセサリー</a>
</li>
</div>
</ul>
</dd>
